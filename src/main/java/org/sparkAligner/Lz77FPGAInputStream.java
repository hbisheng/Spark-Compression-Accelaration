...
import static org.sparkAligner.SnappyFramed.STREAM_IDENTIFIER_FLAG;
import static org.sparkAligner.SnappyFramed.UNCOMPRESSED_DATA_FLAG;
import static org.sparkAligner.SnappyFramed.readBytes;
import static org.sparkAligner.SnappyFramed.releaseDirectByteBuffer;
import static org.sparkAligner.SnappyFramedOutputStream.MAX_BLOCK_SIZE;
 ...
 * @since 1.1.0
 */
public final class Lz77FPGAInputStream
        extends InputStream
        implements
        ReadableByteChannel
{
     ...
     */
    public Lz77FPGAInputStream(InputStream in)
            throws IOException
    {
        this(in, true);
    }
     ...
     */
    public Lz77FPGAInputStream(InputStream in, boolean verifyChecksums)
            throws IOException
    {
     ...
     */
    public Lz77FPGAInputStream(ReadableByteChannel in)
            throws IOException
    {
        this(in, true);
    }
