 ...
 */
public class TmpGzipCodec implements Configurable, CompressionCodec {
    private static final Log LOG = LogFactory.getLog(TmpGzipCodec.class);
    ...
    public TmpGzipCodec(final Configuration conf) {
        this.conf = conf;
    }
